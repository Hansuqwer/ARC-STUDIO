/** ARC Workflow Graph Contribution — registers the workflow graph view. */
...
@injectable()
export class ArcWorkflowContribution extends AbstractViewContribution<ArcWorkflowGraphWidget> {
    constructor() {
        super({
