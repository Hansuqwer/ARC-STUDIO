...
|---|---|---|---|
| Shell chrome | focused landmark, command palette open/closed, daemon healthy/degraded | F6/Shift-F6 cycles all landmarks | **PASS** — `m11-focus-editor-2026-06-13.png`, `m11-focus-dock-2026-06-13.png`: F6 cycles Workspace→Search→Editor→ARC dock→Status rail; focused landmark highlighted + announced |
...
| Editor | empty, dirty, saved, open error, save error | type, select, copy/paste, undo/redo, save/reopen | **PASS** — `m11-editor-copy-paste-2026-06-13.png`: Cmd+A select-all + `selected:0..24` + dirty marker; Cmd+C/V/X/A wired; baseline keyboard/dirty in `m8-editor-dirty-2026-06-13.png` |
