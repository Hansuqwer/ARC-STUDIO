...
class DeepseekFimClient(IBaseClient):
    ...
    async def create(
        ...
        start_phrases = self.generate_start_phrases_for_model(model, options.prompt_index)
    ...
    def generate_start_phrases_for_model(self, model: str, prompt_index):
        return generate_start_phrases_for_model(self._prompt_generators, prompt_index, model)
