...
class IBaseClient(ABC):
    ...
    @abstractmethod
    def generate_prompt_for_model(self, state: State, model: str, prompt_index: int) -> str:
        """
    ...
    @abstractmethod
    def generate_stop_tokens_for_model(self, model: str, prompt_index: int) -> List[str]:
        """
