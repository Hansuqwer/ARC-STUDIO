...
class UserRepository:
    ...
    def create_user(self, user_id: str, username: str, password: str, metadata: dict = None):
        ...
        if password is not None:
            ...
            user_data[self.PASSWORD_HASH_KEY] = base64.b64encode(password_hash).decode("utf-8")
    ...
    def update_user(
        ...
        if new_password:
            ...
            # Convert byte string to base64-encoded string
            update_data[self.PASSWORD_HASH_KEY] = base64.b64encode(password_hash).decode("utf-8")
        if metadata:
