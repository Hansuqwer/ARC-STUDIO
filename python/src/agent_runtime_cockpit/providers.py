...
PROVIDERS: list[ProviderDefinition] = [
    ...
    ProviderDefinition(id="g4f", display_name="GPT4Free (Groq)", default_base_url="https://g4f.space/api/groq", env_key_names=[], default_models=["llama-3.1-8b-instant", "llama-3.3-70b-versatile", "qwen/qwen3-32b"], supports_tools=True),
]
