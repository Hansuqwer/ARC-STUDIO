...
class MessageOutputItem(_MsgItem):
    pass


class ToolCallItem(_ToolCallItem):
    pass


class ToolCallOutputItem(_ToolOut):
    pass


class HandoffOutputItem(_Handoff):
    pass
...
def test_full_stream_maps_to_ag_ui():
    ...
    msg = MessageOutputItem(
        agent=a, raw_item=type("M", (), {"content": [type("T", (), {"text": "Hi"})]})()
    )
