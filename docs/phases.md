...
6. **Phase 104 + 105 resumed ← NEXT** — microVM macOS hardening + Linux Firecracker host proof. macOS gated pwd proof is now reproducible via tools/arc-vz-bringup.sh; remaining: full test suite + SIGINT/timeout proofs (Phase 104). Linux/Firecracker deferred to Linux/KVM host.
