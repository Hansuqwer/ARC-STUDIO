...
**Status:** Slices 110.1–110.4 Baseline Complete / 110.5–110.6 follow-up | Evidence: 2026-06-06 ArcRuntimeSDKAdapter (110.1+110.2) + mobile_sdk_mapping bidirectional (110.3, 25 tests) + arc_runtime_sdk_pack converter (110.4 — arc-sdk.json→RuntimePackManifest, auto-synthesises permissions for R7, real SDK example validates ok=True, 13 tests); 55 tests total. Truth: simulator/mock only, can_run=False, no native-execution/app-store claims. Companion roadmap item: R79.
