...
**Roadmap:** —  
**Status:** Baseline Complete — 8 slices on `phase-4-provider-backed` branch; review-fix code tip `5ed7762`, docs refresh pending final SHA.  
...
### Verification
```bash
cd python && uv run pytest -q          # 1240 passed, 1 pre-existing failure
