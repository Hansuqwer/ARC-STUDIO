...
This file previously contained generated alpha-ready claims. Those claims were too broad for GitHub handoff.

Use the current evidence-based status files instead:
