...
- macOS production-grade/broad microVM execution requires a committed/reviewed initrd builder or artifact policy, stable artifacts, repeated host CI, real timeout/SIGINT/failure proof, broader argv/runtime coverage, and kernel/initrd provenance/distribution/license policy.
