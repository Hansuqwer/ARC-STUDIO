...
- Firecracker guest command channel (`ip route`, failed `curl`, sentinel read, symlink escape read) remains blocked until ARC owns a rootfs/init/vsock/serial agent.
