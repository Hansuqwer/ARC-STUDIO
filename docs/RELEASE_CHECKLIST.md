...
**Evidence refresh:** Docs refreshed against pushed `main` commit `b88b189` on 2026-05-19. All Baseline Complete phases evaluated for polish; decision: ship as-is, defer polish to v0.2 (see Polish Deferral section below). All required GitHub `main` workflows are green: `python` 26104427903, `node` 26104427815, `ARC Roadmap Gate` 26104427662, `e2e` 26104427822, and `signing-preflight` 26104427820. `.env` history scrub completed (see Item 9). Real-runtime smoke remains opt-in/non-gating.
...
**Evidence:** Pushed `main` commit `b88b189`; latest observed `node` workflow on `main` is green.
...
**Evidence:** Pushed `main` commit `b88b189`; latest observed `node` build/test workflow on `main` is green.
...
**Evidence:** Pushed `main` commit `b88b189`; no dedicated GitHub run ID for this CLI-help local check.
...
**Evidence:** Pushed `main` commit `b88b189`; no dedicated GitHub run ID for this capability-report local check.
...
**Evidence:** Pushed `main` commit `b88b189`; latest observed `ARC Roadmap Gate` on `main` is green.
...
Latest local run on 2026-05-19 at `b88b189`: `762 passed, 16 suites`. Jest reports an open-handle notice after completion; tests still exit successfully.

**Evidence:** Pushed `main` commit `b88b189`; latest observed `node` on `main` is green.
...
**Evidence:** Pushed `main` commit `b88b189`; latest observed `e2e` on `main` is green.
...
Release date is set for 2026-06-01. The 3-day green-window starts from the 2026-05-18 green evidence and completes on 2026-05-21 only if required workflows stay green. Latest observed required-ish `main` runs are green on `b88b189`: `python`, `node`, `ARC Roadmap Gate`, `e2e`, and `signing-preflight`. `real-runtime-smoke` remains opt-in/non-gating.
...
**Evidence:** Pushed `main` commit `b88b189`; GitHub issue query refreshed on 2026-05-18 and returned no open issues with label `security`.
...
**Evidence:** Pushed `main` commit `b88b189`; latest observed release-doc-related gate is green via `ARC Roadmap Gate`.
