...
| R-AUDIT27 | IDE status rail (mode/trust/model/daemon) | Not Started | Evidence: — | Notes: persistent IDE top rail surfacing mode/trust/model/daemon; absent in `arc-extension` today. Source: unified-backlog SLICE 13 (P1). |
