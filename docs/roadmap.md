...
| R-MOBILE-AUDIT | Mobile SDK Audit Hardening (Phase 207) | Status: Baseline Complete | Evidence: local worktree 2026-06-08 | _Base extra=forbid (unknown-field injection closed); write_requires_hitl_or_trust always ERROR; write caps require trust; fixture regenerated. 308 tests; ruff clean. |
| R-MOBILE-AUDIT-TS | TS type guards + Expo/RN package.json + Flutter pubspec (Phases 209-210) | Status: Baseline Complete | Evidence: local worktree 2026-06-08 | isMobileCapability/isMobileRuntimeManifest check 6 discriminants; Expo/RN package.json main→dist; Flutter pubspec accurate; privacy_manifest_intent in TS mirror; AUDIT_REPORT committed. 968 arc-extension + 11 mobile-runtime tests passed. |
