...
- `arc sandbox vz-artifacts --exec-init --output <dir> --json` writes a reviewable VZ guest init contract plus manifest. It does not build an initrd, download assets, bundle Python, or boot a VM.
